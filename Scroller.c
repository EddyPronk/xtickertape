/***************************************************************
  ...
  Copyright (C) 1997-2004 by Mantara Software (ABN 17 105 665 594).
  All Rights Reserved.
...
#ifndef lint
static const char cvsid[] = "$Id: Scroller.c,v 1.146 2004/08/02 22:24:16 phelps Exp $";
#endif /* lint */
...
static void expose(Widget widget, XEvent *event, Region region);
...
static glyph_holder_t glyph_holder_alloc(glyph_t glyph, int width)
{
    glyph_holder_t self;
