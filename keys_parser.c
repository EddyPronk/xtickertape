/***************************************************************
  ...
  Copyright (C) DSTC Pty Ltd (ACN 052 372 577) 2002-2003.
...
#ifndef lint
static const char cvsid[] = "$Id: keys_parser.c,v 1.7 2003/01/23 09:47:11 phelps Exp $";
#endif /* lint */
...
{
    unsigned char *end = (unsigned char *)buffer;
